...
from sections.serializers.content_serializers import ContentSerializer, SectionContentSerializer, SectionContentListSerializer
...
class SectionCreateAPIView(ListAPIView):
